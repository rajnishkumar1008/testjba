...
const ForgetPassword = () => {
  return (
    <div>
         <Head>
      <title>Forget Password | JBA</title>
              ...
              <div className="jba-login-page jba-registraion-page">
                ...
                <div className="jab-log-form jab-regi-form">
                  ...
                  <form>
                    ...
                    <div className="row">
                        <div className="col-lg-6"><input type="email" placeholder=" Enter Your Email ID" /></div>
                    ...
                    <div className='more-opt'>
                                    <p> Back to   <Link href="/registration/"><a>Login </a></Link></p>
                                </div>
                  </form>
                </div>
              </div>
